	...
	return (
		<>
			...
			<form onSubmit={handleSubmit} className="bg-gray-700 flex flex-col pl-2 pb-2">
				...
				<textarea key="23" type="text" className="bg-gray-900 block rounded w-[90%] px-5 h-14 mb-2" onChange={event => setSkills(event.target.value)} ></textarea>
				...
				<textarea key="24" type="text" className="bg-gray-900 block rounded w-[90%] px-5 h-14 mb-2" onChange={event => setInventory(event.target.value)} ></textarea>
