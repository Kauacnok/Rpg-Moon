	...
	return (
		<>
			...
			<form onSubmit={handleSubmit} className="bg-gray-700 flex flex-col pl-2 pb-2">
				...
				<textarea type="text" className="bg-gray-900 block rounded w-[90%] px-5 h-14 mb-2" onChange={event => setSkills(event.target.value)}></textarea>
				<h2 className="block pl-2 my-10 text-center">Inventário</h2>
				<textarea type="text" className="bg-gray-900 block rounded w-[90%] px-5 h-14 mb-2" onChange={event => setInventory(event.target.value)}></textarea>
