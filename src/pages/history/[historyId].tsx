	...
	return (
		<div className="px-8">
			...
			<main className="my-[90px] pl-2 py-5 bg-gray-900 border-[2px] border-zinc-800 rounded" >
				<nav className="flex justify-between my-[90px] items-center bg-gray-900 p-5">
				...
				<textarea readOnly value={data.historySession.textHistory} className="bg-gray-900 w-[90%] h-[400px] focus:outline-none"></textarea>
